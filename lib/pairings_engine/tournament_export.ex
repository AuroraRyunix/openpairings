defmodule PairingsEngine.TournamentExport do
  ...
  #     chain ever owned.
  #   public_slug_minted_at
  #     Describes `public_slug`, which is excluded above: the imported copy
  #     gets a fresh placeholder slug, and carrying "the results site created
  #     this slug" onto it would make every surface hand out a link to an
  ...
  @excluded_tournament_fields ~w(
    id user_id inserted_at updated_at public_slug public_slug_minted_at
