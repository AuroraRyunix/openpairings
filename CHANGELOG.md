...
- [Security] **Two dependency advisories closed.** mint 1.10.0 -> 1.10.1
  ...
  unescaped. typed_struct 0.3.0, websock 0.5.3 and websock_adapter 0.6.0
...
- [Feature] **Team tournaments publish to OpenResults.** The refusal that
  ...
  The team data travels for a team round robin and for a team Swiss paired
  by teams; a team Swiss that was already paired player by player before this
